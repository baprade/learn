        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <a href="{{ route('home') }}" class="flex items-center gap-2.5 group">
                    <img src="{{ asset('favico.ico') }}" alt="Learn Logo" class="w-8 h-8 rounded object-contain bg-slate-900 border border-slate-800 p-0.5 group-hover:border-emerald-500/50 transition-all">
                ...
                <nav class="hidden md:flex items-center gap-6 text-xs font-medium text-slate-300">
                    ...
                    <a href="{{ config('learn_seo.jasa_site') }}" target="_blank" rel="noopener" class="hover:text-emerald-400 transition-colors">
    ...
    <footer class="bg-[#060910] border-t border-slate-900 py-6 relative z-10 text-xs text-slate-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div class="flex items-center gap-2">
                <img src="{{ asset('favico.ico') }}" alt="Logo" class="w-4 h-4 rounded object-contain">
                <span>&copy; {{ date('Y') }} Learn Baprade. Interactive PHP & SQL Code Sandbox.</span>
            </div>
